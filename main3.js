class Glasses {
        constructor(scene, width, height, environmentMap) {
                ...
                this.loadGlasses("https://charpstar.se/ar/VTO/Git3/3d/8.glb");
        }
                                                ...
                                                if (node.isMesh) {
                                                        ...
                                                        const setTextureEncoding = (texture) => {
                                                                if (texture) {
                                                                        ...
                                                                        texture.format = THREE.RGBAFormat; // Add this line
                                                                        texture.type = THREE.UnsignedByteType; // Add this line
                                                                }
                                                        };
...
class SceneManager {
        constructor(canvas, debug = false, useOrtho = true) {
                ...
                this.loadEnvironmentMap();
                    ...
                    const bloomPass = new THREE.UnrealBloomPass(new THREE.Vector2(this.width, this.height), 1.5, 0.4, 0.85);
                    bloomPass.threshold = 0;
                    bloomPass.strength = 1.5;
                    bloomPass.radius = 0.4;
                    bloomPass.resolution = 0.85;
        ...
        buildLights() {
                ...
                const pointLight = new THREE.PointLight(0xffffff, 3.6, 100);
