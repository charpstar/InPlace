const charpstarVTO = {
	...
	createPopup() {
		...
		canvas.style.zIndex = "10001"; // To overlap the video element
		...
		closeButton.style.zIndex = "10002"; // To make sure it's above the video and canvas
		...
		this.sceneManager = new SceneManager(canvas, true, this.useOrtho);
